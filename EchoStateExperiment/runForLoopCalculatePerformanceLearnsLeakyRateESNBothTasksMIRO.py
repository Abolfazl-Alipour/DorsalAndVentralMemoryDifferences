...
# -*- coding: utf-8 -*-
"""
Created on Tue Dec 15 13:57:19 2020
...
from loadPretrainedclassifierAndIncorporateitintoESNForRotatingObjLeakyRatechangesMIRO import ESNRotatingObjectLrnLeakyRate
from loadPretrainedclassifierAndIncorporateitintoESNForFixedWidthLeakyRatechangesMIRO import ESNFixedWidthLrnLeakyRate
...
# # Saving the results:
# with open('/N/u/aalipour/Karst/2ndYearProject/2020Wave/code/ReviewersAsked/code/ESNObjLeakyRateLrnsMIROMidSizeNtwSze20.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
#     pickle.dump([rotatObjAccuracyMat, rotatObjleakyRateMat], f)
#     # f.close()
# # # Getting back the objects:
# with open('/N/u/aalipour/Karst/2ndYearProject/2020Wave/code/ReviewersAsked/code/ESNObjLeakyRateLrnsMIROMidSizeNtwSze20.pkl','rb') as f:  # Python 3: open(..., 'rb')
...
# # Saving the results:
# with open('/N/u/aalipour/Karst/2ndYearProject/2020Wave/code/ReviewersAsked/code/ESNWidthLeakyRateLrnsMIROMidSizeNtwSze20.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
#     pickle.dump([fixedWidthAccuracyMat, fixedWidthleakyRateMat], f)
#     # f.close()
# # # Getting back the objects:
# with open('/N/u/aalipour/Karst/2ndYearProject/2020Wave/code/ReviewersAsked/code/ESNWidthLeakyRateLrnsMIROMidSizeNtwSze20.pkl','rb') as f:  # Python 3: open(..., 'rb')
...
# Saving the results:
with open('/N/u/aalipour/Karst/2ndYearProject/2020Wave/code/ReviewersAsked/code/ESNObjLeakyRateLrnsMIROMidSizeNtwSze20RandLeak.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
    pickle.dump([rotatObjAccuracyMat, rotatObjleakyRateMat], f)
    f.close()
# # Getting back the objects:
with open('/N/u/aalipour/Karst/2ndYearProject/2020Wave/code/ReviewersAsked/code/ESNObjLeakyRateLrnsMIROMidSizeNtwSze20RandLeak.pkl','rb') as f:  # Python 3: open(..., 'rb')
    rotatObjAccuracyMat, rotatObjleakyRateMat = pickle.load(f)
...
# Saving the results:
with open('/N/u/aalipour/Karst/2ndYearProject/2020Wave/code/ReviewersAsked/code/ESNWidthLeakyRateLrnsMIROMidSizeNtwSze20RandLeak.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
    pickle.dump([fixedWidthAccuracyMat, fixedWidthleakyRateMat], f)
    f.close()
# # Getting back the objects:
with open('/N/u/aalipour/Karst/2ndYearProject/2020Wave/code/ReviewersAsked/code/ESNWidthLeakyRateLrnsMIROMidSizeNtwSze20RandLeak.pkl','rb') as f:  # Python 3: open(..., 'rb')
    fixedWidthAccuracyMat, fixedWidthleakyRateMat = pickle.load(f)
...
sns.boxplot( data=[1-obj[:,0,17],1-width[:,0,17]],ax=ax1,palette=my_pal).set(ylabel='Memory Coefficient', xticklabels=['Object','Orientation'])
ax1.set_ylim(.1, .9)
...
ax.tick_params(labelsize=16) 
ax.set_ylabel('Memory Coefficient',size=24)
sns.boxplot( data=[1-obj[:,1,17],1-width[:,1,17]],ax=ax2,palette=my_pal).set(yticklabels=[],xticklabels=['Object','Orientation'])
ax2.set_ylim(.1, .9)
ax2.tick_params(labelsize=16) 
...
ax.set_ylabel('Memory Coefficient',size=24)
sns.boxplot( data=[1-obj[:,2,17],1-width[:,2,17]],ax=ax3,palette=my_pal).set(yticklabels=[],xticklabels=['Object','Orientation'])
ax3.set_ylim(.1, .9)
