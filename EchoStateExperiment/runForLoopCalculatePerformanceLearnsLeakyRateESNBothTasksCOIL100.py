...
# # Saving the results:
# with open('/N/u/aalipour/Karst/2ndYearProject/2020Wave/code/ReviewersAsked/code/ESNObjLeakyRateLrnsCOIL100.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
#     pickle.dump([rotatObjAccuracyMat, rotatObjleakyRateMat], f)
#     # f.close()
# # # Getting back the objects:
# with open('/N/u/aalipour/Karst/2ndYearProject/2020Wave/code/ReviewersAsked/code/ESNObjLeakyRateLrnsCOIL100.pkl','rb') as f:  # Python 3: open(..., 'rb')
...
for j in tqdm(range(len(randomSeedList))):
        i=0
        tmp=ESNRotatingObjectLrnLeakyRate(intialLeakyRateVec[0,j],nIterations,randomSeedList[j])
        rotatObjAccuracyMat[j,i,0:nIterations]=torch.FloatTensor(tmp[0])
        rotatObjleakyRateMat[j,i,0:nIterations]=torch.FloatTensor(tmp[1]).t()
...
# # Saving the results:
# with open('/N/u/aalipour/Karst/2ndYearProject/2020Wave/code/ReviewersAsked/code/ESNObjLeakyRateLrnsCOIL100RandLeak.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
#     pickle.dump([rotatObjAccuracyMat, rotatObjleakyRateMat], f)
#     f.close()
# # # Getting back the objects:
# with open('/N/u/aalipour/Karst/2ndYearProject/2020Wave/code/ReviewersAsked/code/ESNObjLeakyRateLrnsCOIL100RandLeak.pkl','rb') as f:  # Python 3: open(..., 'rb')
#     rotatObjAccuracyMat, rotatObjleakyRateMat = pickle.load(f)


# Saving the results:
with open('/N/u/aalipour/Karst/2ndYearProject/2020Wave/code/ReviewersAsked/code/ESNObjLeakyRateLrnsCOIL100RandLeakEqlClss.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
    pickle.dump([rotatObjAccuracyMat, rotatObjleakyRateMat], f)
    f.close()
# # Getting back the objects:
with open('/N/u/aalipour/Karst/2ndYearProject/2020Wave/code/ReviewersAsked/code/ESNObjLeakyRateLrnsCOIL100RandLeakEqlClss.pkl','rb') as f:  # Python 3: open(..., 'rb')
    rotatObjAccuracyMat, rotatObjleakyRateMat = pickle.load(f)
...
for j in tqdm(range(len(randomSeedList))):
        i=0
        tmp=ESNFixedWidthLrnLeakyRate(intialLeakyRateVec[0,j],nIterations,randomSeedList[j],numOfClasses=8)
#        pdb.set_trace()
        fixedWidthAccuracyMat[j,i,0:nIterations]=torch.FloatTensor(tmp[0])
        fixedWidthleakyRateMat[j,i,0:nIterations]=torch.FloatTensor(tmp[1]).t()
        i=i+1
...
# # Saving the results:
# with open('/N/u/aalipour/Karst/2ndYearProject/2020Wave/code/ReviewersAsked/code/ESNWidthLeakyRateLrnsCOIL100RandLeak.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
#     pickle.dump([fixedWidthAccuracyMat, fixedWidthleakyRateMat], f)
#     f.close()
# # # Getting back the objects:
# with open('/N/u/aalipour/Karst/2ndYearProject/2020Wave/code/ReviewersAsked/code/ESNWidthLeakyRateLrnsCOIL100RandLeak.pkl','rb') as f:  # Python 3: open(..., 'rb')
#     fixedWidthAccuracyMat, fixedWidthleakyRateMat = pickle.load(f)



# Saving the results:
with open('/N/u/aalipour/Karst/2ndYearProject/2020Wave/code/ReviewersAsked/code/ESNWidthLeakyRateLrnsCOIL100RandLeakEqlClss.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
    pickle.dump([fixedWidthAccuracyMat, fixedWidthleakyRateMat], f)
    f.close()
# # Getting back the objects:
with open('/N/u/aalipour/Karst/2ndYearProject/2020Wave/code/ReviewersAsked/code/ESNWidthLeakyRateLrnsCOIL100RandLeakEqlClss.pkl','rb') as f:  # Python 3: open(..., 'rb')
    fixedWidthAccuracyMat, fixedWidthleakyRateMat = pickle.load(f)
