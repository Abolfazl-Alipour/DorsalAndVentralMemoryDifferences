# -*- coding: utf-8 -*-
"""
Created on Fri Sep  6 18:08:28 2019
...
network.frame.load_state_dict(torch.load('/geode2/home/u010/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/savedNetworks/TestTrain/widthClassifierTrainTest75PRCNT-200Epoch'))
...
def ESNFixedWidth(forgetRate=0.5,n_iterations=4,seed=72347,n_hidden = 200,use_cuda=True):
    # Parameters
    spectral_radius = 0.9
    learning_rate = 0.005
    batch_size = 1
    ...
    class column(nn.Module):
        ...
        def __init__(self,preTrainedModel,forgetRate,spectral_radius = spectral_radius,n_hidden = n_hidden,numOfClasses=numOfClasses,lastLayerSize=lastLayerSize):
            ...
            self.echo=etnn.LiESNCell(forgetRate,train_forgetRate,inputRate,train_inputRate,lastLayerSize, n_hidden, spectral_radius=spectral_radius,seed=seed)#,nonlin_func=torch.nn.functional.relu
...
#                pdb.set_trace()
    ...
    train_set = tomImageFolderFrameSeriesAllClasses(root=os.path.join('/geode2/home/u010/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/TrainTest/SyntheticWidth/train'),transform=transform)
    
    test_set = tomImageFolderFrameSeriesAllClasses(root=os.path.join('/geode2/home/u010/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/TrainTest/SyntheticWidth/validation'),transform=transform)
