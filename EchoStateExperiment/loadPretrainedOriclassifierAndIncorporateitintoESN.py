# -*- coding: utf-8 -*-
"""
Created on Tue Aug 13 12:46:59 2019
...
train_set = dset.ImageFolder(root=os.path.join('E:\\', 'Abolfazl' , '2ndYearproject' , 'ImagesGeneratedTom' , 'fixedOrientation','rotatedStims' ),transform=transform)

test_set = dset.ImageFolder(root=os.path.join('E:\\','Abolfazl','2ndYearproject','ImagesGeneratedTom','fixedOrientation','rotatedStims'),transform=transform)
