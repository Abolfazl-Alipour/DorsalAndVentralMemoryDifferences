...
# Saving the results:
with open('/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ReviewersAsked/code/MIROObjTrainTest200Epoch10-3LerRateSpinerMidSize.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
