...
# -*- coding: utf-8 -*-
"""
Created on Mon Apr 19 20:53:48 2021
...
network.frame.load_state_dict(torch.load('/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ReviewersAsked/savedNetworks/oriClassifierMIRO_71PRCNTTrain60Test40FiftyEpochs4Class45Spin'))
...
def LSTMforFixedWidthForget2InputRatio(n_hidden = 200,n_epochs = 10,use_cuda = False,numOfClasses=4):
    # Parameters
    learning_rate = 0.001
    batch_size = 1
    ...
    train_set = tomImageFolderFrameSeriesAllClasses(root=os.path.join('/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/TrainTest/revierwersAsked/MIROMidsizeOri/train' ),transform=transform)
    
    test_set = tomImageFolderFrameSeriesAllClasses(root=os.path.join('/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/TrainTest/revierwersAsked/MIROMidsizeOri/validation' ),transform=transform)
...
for ii in tqdm(range(len(nHiddSizeVec))):
    ...
    with open('/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ReviewersAsked/code/MIROOriTrainTest200Epoch10-3LerRateMidSizeAllEpchsSize='+ str(nHiddSizeVec[ii])+'.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
...
# # Saving the results:
# with open('/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ReviewersAsked/code/MIROOriTrainTest200Epoch10-3LerRateMidSizeAllEpchs.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
#     pickle.dump([accResultLSTMFixedWidth, cumFGateValsMIROOri, cumIGateValsMIROOri], f)
#     f.close()
