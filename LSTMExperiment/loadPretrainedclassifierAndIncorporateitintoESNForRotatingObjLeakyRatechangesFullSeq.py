# -*- coding: utf-8 -*-
"""
Created on Sun Oct  6 19:04:01 2019
...
from tomDatasetFrameSeriesAllClassesObjIdentityFullSeq import tomImageFolderFrameSeriesAllClasses
import mdp
import pdb
...
def ESNRotatingObjectLrnLeakyRate(leaky_rate=0.5, n_iterations=1,seed=1234567890):
    # Parameters
    spectral_radius = 0.9
