...
# -*- coding: utf-8 -*-
"""
Created on Mon Apr 19 21:00:55 2021
...
# -*- coding: utf-8 -*-
"""
Created on Tue Dec 15 13:37:04 2020
...
network.frame.load_state_dict(torch.load('/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ReviewersAsked/savedNetworks/objClassifierMIRO_70PRCNTTrain60Test40FiftyEpochs45Spin'))
...
def LSTMforRotObjForget2InputRatio(n_hidden = 200,n_epochs = 1,use_cuda = False,numOfClasses=6):
# Parameters

    learning_rate = 0.001 #the learning reate had been lowered in here to improve accuracy
    batch_size = 1
    ...
    train_set = tomImageFolderFrameSeriesAllClasses('/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/TrainTest/revierwersAsked/MIROMidsizeObj/train',transform=transform)
    
    test_set = tomImageFolderFrameSeriesAllClasses('/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/TrainTest/revierwersAsked/MIROMidsizeObj/validation' ,transform=transform)
...
nHiddSizeVec=[160]#[20]#,40,80,160,320,640]
numberOfRealizations=30
n_epochs=200#40
# numOfFrames=72
numOfObjClasses=54
accResultLSTMRotObj=np.empty([len(nHiddSizeVec),numberOfRealizations,int(n_epochs/10)])
accResultLSTMRotObj[:]=np.nan
cumFGateValsMIROObj=[]#len(nHiddSizeVec),numberOfRealizations,numOfWidthClasses,[],nHiddSizeVec[-1]]
cumIGateValsMIROObj=[]
...
for ii in tqdm(range(len(nHiddSizeVec))):
    ...
    cumFGateValsMIROObj.append(cumFGateValsOfSize)
    cumIGateValsMIROObj.append(cumIGateValsOfSize)
    with open('/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ReviewersAsked/code/MIROObjTrainTest200Epoch10-3LerRateSpinerMidSizeAllEpchsSize='+ str(nHiddSizeVec[ii])+'.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
        pickle.dump([accResultLSTMRotObj, cumFGateValsMIROObj, cumIGateValsMIROObj], f)
        f.close()
...
# # Saving the results:
# with open('/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ReviewersAsked/code/MIROObjTrainTest200Epoch10-3LerRateSpinerMidSizeAllEpchs.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
#     pickle.dump([accResultLSTMRotObj, cumFGateValsMIROObj, cumIGateValsMIROObj], f)
#     f.close()
# # Getting back the objects:
# with open('/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ReviewersAsked/code/MIROObjTrainTest200Epoch10-3LerRate30deg5degwiggleAllEpchs.pkl','rb') as f:  # Python 3: open(..., 'rb')
