...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb 16 19:08:01 2021
...
# -*- coding: utf-8 -*-
"""
Created on Thu Dec 24 13:56:18 2020
...
network.frame.load_state_dict(torch.load('/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ReviewersAsked/savedNetworks/objClassifierMIRO_46PRCNTTrain60Test40FiftyEpochsFineGrain8class'))
...
def LSTMforRotObjForget2InputRatio(n_hidden = 200,n_epochs = 1,use_cuda = False,numOfClasses=22):
# Parameters
    ...
    train_set = tomImageFolderFrameSeriesAllClasses('/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/TrainTest/revierwersAsked/MIROMidsizeFineGrainObj8class/train',transform=transform)
    
    test_set = tomImageFolderFrameSeriesAllClasses('/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/TrainTest/revierwersAsked/MIROMidsizeFineGrainObj8class/validation' ,transform=transform)
...
# Saving the results:
with open('/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ReviewersAsked/code/MIROObjTrainTest200Epoch10-4LerRateSpinerMidSizeFG8Cls.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
    pickle.dump([accResultLSTMRotObj, cumFGateValsMIROObj, cumIGateValsMIROObj], f)
    f.close()
# Getting back the objects:
# with open('/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ReviewersAsked/code/MIROObjTrainTest200Epoch10-4LerRateSpinerMidSizeFG8Cls.pkl','rb') as f:  # Python 3: open(..., 'rb')
