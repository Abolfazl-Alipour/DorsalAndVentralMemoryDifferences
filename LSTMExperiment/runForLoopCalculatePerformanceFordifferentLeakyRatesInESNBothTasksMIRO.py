...
# Saving the results:
with open('/geode2/home/u010/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ReviewersAsked/code/ESNObjAllLeakingRatesMIROMIDSIZE7Iterations.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
    pickle.dump([resultsRotObj], f)
    # f.close()
# # Getting back the objects:
with open('/geode2/home/u010/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ReviewersAsked/code/ESNObjAllLeakingRatesMIROMIDSIZE7Iterations.pkl','rb') as f:  # Python 3: open(..., 'rb')
...
# Saving the results:
with open('/geode2/home/u010/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ReviewersAsked/code/ESNWidthAllLeakingRatesMIROMIDSIZE7Iterations.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
    pickle.dump([resultsFixedWidth], f)
    # f.close()
# # Getting back the objects:
with open('/geode2/home/u010/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ReviewersAsked/code/ESNWidthAllLeakingRatesMIROMIDSIZE7Iterations.pkl','rb') as f:  # Python 3: open(..., 'rb')
    resultsFixedWidth = pickle.load(f)

# a=np.concatenate((tmpObj,resultsRotObj[0]),axis=0)
#plt.figure()
