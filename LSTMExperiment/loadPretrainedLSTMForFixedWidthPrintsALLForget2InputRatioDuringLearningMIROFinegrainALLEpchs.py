...
# -*- coding: utf-8 -*-
"""
Created on Mon Apr 19 21:13:27 2021
...
for ii in tqdm(range(len(nHiddSizeVec))):
    ...
    with open('/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ReviewersAsked/code/MIROOriTrainTest200Epoch10-3LerRateMidSizeFGAllEpchsSize='+ str(nHiddSizeVec[ii])+'.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
...
# # Saving the results:
# with open('/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ReviewersAsked/code/MIROOriTrainTest200Epoch10-3LerRateMidSizeFGAllEpchs.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
#     pickle.dump([accResultLSTMFixedWidth, cumFGateValsMIROOri, cumIGateValsMIROOri], f)
#     f.close()
