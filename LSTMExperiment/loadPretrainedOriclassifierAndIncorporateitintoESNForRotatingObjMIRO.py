...
import mdp
import pdb
path2Network='/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ReviewersAsked/savedNetworks/objClassifierMIRO_70PRCNTTrain60Test40FiftyEpochs45Spin'
path2TrainDataset='/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/TrainTest/revierwersAsked/MIROMidsizeObj/train'
path2TestDataset='/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/TrainTest/revierwersAsked/MIROMidsizeObj/validation'
...
def ESNRotatingObject(forgetRate=0.5,n_iterations=4,seed=546867, n_hidden = 200,use_cuda=True,numOfClasses=6):
    # Parameters
    spectral_radius = 0.9
    learning_rate = 0.001
    batch_size = 1
