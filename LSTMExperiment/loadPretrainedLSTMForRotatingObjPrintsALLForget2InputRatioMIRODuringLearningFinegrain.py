...
network.frame.load_state_dict(torch.load('/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ReviewersAsked/savedNetworks/objClassifierMIRO_47PRCNTTrain60Test40FiftyEpochsFineGrain'))
...
# Parameters
    ...
    train_set = tomImageFolderFrameSeriesAllClasses('/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/TrainTest/revierwersAsked/MIROMidsizeFinegrainObj/train',transform=transform)
    
    test_set = tomImageFolderFrameSeriesAllClasses('/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/TrainTest/revierwersAsked/MIROMidsizeFinegrainObj/validation' ,transform=transform)
...
# Saving the results:
with open('/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ReviewersAsked/code/MIROObjTrainTest200Epoch10-3LerRateSpinerMidSizeFG.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
