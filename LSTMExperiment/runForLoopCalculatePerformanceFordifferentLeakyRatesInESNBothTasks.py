...
# Saving the results:
with open('/geode2/home/u010/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ReviewersAsked/code/ESNObjAllLeakingRates.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
    pickle.dump([resultsRotObj], f)
    f.close()
# Getting back the objects:
with open('/geode2/home/u010/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ReviewersAsked/code/ESNObjAllLeakingRates.pkl','rb') as f:  # Python 3: open(..., 'rb')
...
# Saving the results:
with open('/geode2/home/u010/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ReviewersAsked/code/ESNWidthAllLeakingRates.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
    pickle.dump([resultsFixedWidth], f)
    # f.close()
# Getting back the objects:
with open('/geode2/home/u010/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ReviewersAsked/code/ESNWidthAllLeakingRates.pkl','rb') as f:  # Python 3: open(..., 'rb')
...
resultsRotObj=np.array(resultsRotObj).squeeze(0)
...
resultsFixedWidth=np.array(resultsFixedWidth).squeeze(0)
for netwSize in range(len(nHiddSizeVec)):      
...
for netwSize in range(len(nHiddSizeVec)):         
    ...
    plt.xlabel('Memory Coefficient',fontsize=24)
    plt.ylabel('Accuracy (%)',fontsize=24)
    plt.xticks(ticks=[0,10, 20, 30, 40, 50 ],labels=[0,0.20, 0.40, 0.60, 0.80, 1.0 ],fontsize=22)
    plt.yticks(ticks=[ 40, 50,60,70,80,90,100 ],labels=[40, 50,60,70,80,90,100],fontsize=22)
    axes = plt.gca()
