...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb 16 19:03:14 2021
...
network.frame.load_state_dict(torch.load('/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ReviewersAsked/savedNetworks/oriClassifierMIRO_45PRCNTTrain60Test40FiftyEpochs8ClassFineGrain8ClassEquiv'))
...
def LSTMforFixedWidthForget2InputRatio(n_hidden = 200,n_epochs = 10,use_cuda = False,numOfClasses=8):
    ...
    train_set = tomImageFolderFrameSeriesAllClasses(root=os.path.join('/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/TrainTest/revierwersAsked/MIROMidsizeFineGrainObj8classOriEqualivalent/train' ),transform=transform)
    
    test_set = tomImageFolderFrameSeriesAllClasses(root=os.path.join('/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/TrainTest/revierwersAsked/MIROMidsizeFineGrainObj8classOriEqualivalent/validation' ),transform=transform)
...
# Saving the results:
with open('/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ReviewersAsked/code/MIROOriTrainTest200Epoch10-4LerRateMidSizeFG8Cls.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
    pickle.dump([accResultLSTMFixedWidth, cumFGateValsMIROOri, cumIGateValsMIROOri], f)
    f.close()
# Getting back the objects:
# with open('/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ReviewersAsked/code/MIROOriTrainTest200Epoch10-4LerRateMidSizeFG8Cls.pkl','rb') as f:  # Python 3: open(..., 'rb')
