...
# -*- coding: utf-8 -*-
"""
Created on Mon Apr 19 17:56:15 2021
...
network.frame.load_state_dict(torch.load('/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ReviewersAsked/savedNetworks/objClassifierCOIL100_61PRCNTTrain60Test40FiftyEpochs30Deg5DegWiggle'))
...
# Parameters
    ...
    train_set = tomImageFolderFrameSeriesAllClasses('/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/TrainTest/revierwersAsked/Coil100Obj30DegWigglePlusMinus5SixtyForty/train',transform=transform)
    
    test_set = tomImageFolderFrameSeriesAllClasses('/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/TrainTest/revierwersAsked/Coil100Obj30DegWigglePlusMinus5SixtyForty/validation' ,transform=transform)
...
for ii in tqdm(range(len(nHiddSizeVec))):
    ...
    with open('/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ReviewersAsked/code/Coil100ObjTrainTest200Epoch10-4LerRate30deg5degwiggleAllEpchsSize='+ str(nHiddSizeVec[ii])+'.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
