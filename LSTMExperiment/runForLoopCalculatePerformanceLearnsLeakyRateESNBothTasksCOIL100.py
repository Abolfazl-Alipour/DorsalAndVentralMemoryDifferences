...
# -*- coding: utf-8 -*-
"""
Created on Mon May  4 15:15:10 2020
...
# Saving the results:
with open('/N/u/aalipour/Karst/2ndYearProject/2020Wave/code/ESNObjLeakyRateLrns.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
    pickle.dump([rotatObjAccuracyMat, rotatObjleakyRateMat], f)
    # f.close()
# # Getting back the objects:
with open('/N/u/aalipour/Karst/2ndYearProject/2020Wave/code/ESNObjLeakyRateLrns.pkl','rb') as f:  # Python 3: open(..., 'rb')
...
# Saving the results:
with open('/N/u/aalipour/Karst/2ndYearProject/2020Wave/code/ESNWidthLeakyRateLrns.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
    pickle.dump([fixedWidthAccuracyMat, fixedWidthleakyRateMat], f)
    # f.close()
# # Getting back the objects:
with open('/N/u/aalipour/Karst/2ndYearProject/2020Wave/code/ESNWidthLeakyRateLrns.pkl','rb') as f:  # Python 3: open(..., 'rb')
