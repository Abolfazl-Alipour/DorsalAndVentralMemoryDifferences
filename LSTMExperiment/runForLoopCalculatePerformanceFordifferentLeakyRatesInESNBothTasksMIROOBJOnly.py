...
# Saving the results:
with open('/geode2/home/u010/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ReviewersAsked/code/ESNObjAllLeakingRatesMIROMIDSIZERound2.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
    pickle.dump([resultsRotObj], f)
    # f.close()
# # Getting back the objects:
# with open('/geode2/home/u010/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ReviewersAsked/code/ESNObjAllLeakingRatesMIROMIDSIZE.pkl','rb') as f:  # Python 3: open(..., 'rb')
...
# # Saving the results:
# with open('/geode2/home/u010/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ReviewersAsked/code/ESNWidthAllLeakingRatesCOIL100wiggle5around30.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
#     pickle.dump([resultsFixedWidth], f)
#     # f.close()
# # # Getting back the objects:
# with open('/geode2/home/u010/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ReviewersAsked/code/ESNWidthAllLeakingRatesCOIL100wiggle5around30.pkl','rb') as f:  # Python 3: open(..., 'rb')
