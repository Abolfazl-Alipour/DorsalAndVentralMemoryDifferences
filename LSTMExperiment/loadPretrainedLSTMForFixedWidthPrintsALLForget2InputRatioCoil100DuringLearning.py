...
# Saving the results:
with open('/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ReviewersAsked/code/Coil100OriTrainTest200Epoch10-4LerRate30deg5degwiggle.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
