...
# Saving the results:
with open('/geode2/home/u010/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ESNObjLeakyRateLrns.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
    pickle.dump([rotatObjAccuracyMat, rotatObjleakyRateMat], f)
    # f.close()
# # Getting back the objects:
# with open('/geode2/home/u010/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ESNObjLeakyRateLrns.pkl','rb') as f:  # Python 3: open(..., 'rb')
...
# Saving the results:
with open('/geode2/home/u010/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ESNWidthLeakyRateLrns.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
    pickle.dump([fixedWidthAccuracyMat, fixedWidthleakyRateMat], f)
    # f.close()
# # Getting back the objects:
# with open('/geode2/home/u010/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ESNWidthLeakyRateLrns.pkl','rb') as f:  # Python 3: open(..., 'rb')
...
# import numpy as np
# objAccSTD=np.empty([3,nIterations])
...
# import numpy as np
# widthSTD=np.empty([3,nIterations])
# widthSTD[:]=np.nan
...
# widthAccSTD=np.empty([3,nIterations])
# widthAccSTD[:]=np.nan
