...
# -*- coding: utf-8 -*-
"""
Created on Thu Dec 24 13:31:43 2020
...
# -*- coding: utf-8 -*-
"""
Created on Tue Dec 15 12:57:16 2020
...
import mdp
import pdb
path2Network='/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/code/ReviewersAsked/savedNetworks/objClassifierMIRO_47PRCNTTrain60Test40FiftyEpochsFineGrain'
path2TrainDataset='/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/TrainTest/revierwersAsked/MIROMidsizeFinegrainObj/train'
path2TestDataset='/N/u/aalipour/Carbonate/Downloads/2ndYearproject/2020Wave/TrainTest/revierwersAsked/MIROMidsizeFinegrainObj/validation'
...
def ESNRotatingObject(forgetRate=0.5,n_iterations=4,seed=546867, n_hidden = 200,use_cuda=True,numOfClasses=22):
    # Parameters
    spectral_radius = 0.9
    learning_rate = 0.001
    batch_size = 1
